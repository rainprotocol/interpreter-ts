...
export interface FlowERC721FactoryInterface extends utils.Interface {
  functions: {
    "createChild(bytes)": FunctionFragment;
    "createChildTyped((string,string,(bytes[],uint256[]),(address,address,(bytes[],uint256[])[])))": FunctionFragment;
...
export interface FlowERC721Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlowERC721FactoryInterface;
