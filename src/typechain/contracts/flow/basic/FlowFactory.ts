...
export interface FlowFactoryInterface extends utils.Interface {
  functions: {
    "createChild(bytes)": FunctionFragment;
    "createChildTyped(((bytes[],uint256[]),(address,address,(bytes[],uint256[])[])))": FunctionFragment;
...
export interface FlowFactory extends BaseContract {
