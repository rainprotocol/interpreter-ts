...
export interface FlowERC1155FactoryInterface extends utils.Interface {
  functions: {
    "createChild(bytes)": FunctionFragment;
    "createChildTyped((string,(bytes[],uint256[]),(address,address,(bytes[],uint256[])[])))": FunctionFragment;
...
export interface FlowERC1155Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlowERC1155FactoryInterface;
