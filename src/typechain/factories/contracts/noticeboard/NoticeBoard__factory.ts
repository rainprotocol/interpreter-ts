...
import type {
  NoticeBoard,
  NoticeBoardInterface,
} from "../../../contracts/noticeboard/NoticeBoard";
...
export class NoticeBoard__factory extends ContractFactory {
  ...
  override attach(address: string): NoticeBoard {
    return super.attach(address) as NoticeBoard;
  }
  override connect(signer: Signer): NoticeBoard__factory {
