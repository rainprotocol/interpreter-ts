...
import type {
  CooldownTest,
  CooldownTestInterface,
} from "../../../../contracts/test/cooldown/CooldownTest";
...
export class CooldownTest__factory extends ContractFactory {
  ...
  override attach(address: string): CooldownTest {
    return super.attach(address) as CooldownTest;
  }
  override connect(signer: Signer): CooldownTest__factory {
